...
title('singular values of different N','FontSize',12)
...
title('singular values of different M','FontSize',12)
xlabel('M','FontSize',10);
ylabel('singular values of X','FontSize',10);
% axis([1 128 -0.2 1]);
grid on
...
title('singular values of different \theta','FontSize',12)
xlabel('M','FontSize',10);
ylabel('singular values of X','FontSize',10);
% axis([1 128 -0.2 1]);
grid on
...
title('singular values of different f','FontSize',12)
xlabel('M','FontSize',10);
ylabel('singular values of X','FontSize',10);
% axis([1 128 -0.2 1]);
grid on
